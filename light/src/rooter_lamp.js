...
const all_lamp = [rooter_power, alarm, ppp, light_tel, act, register, initial, option, Authentication, uni, optical_line, power, movie, lan_setup, lan_setup_ararm];
...
const farst_lib = [user_account, cfs, tell_no, west_east];
...
//下の項目
const use = { type: 'radio', label_text: '利用可否', name: 'use', id: ['use_ok', 'use_ng'], value: ['可', '不可'] };
const display = { type: 'radio', label_text: 'ディスプレイ', name: 'display', id: ['display_ok', 'display_ng'], value: ['点灯', '消灯'] };
const outside_call = { type: 'radio', label_text: '外線音', name: 'outside_call', id: ['outside_call_ok', 'outside_call_ng'], value: ['鳴る', '鳴らない'] };
const modular_cable = { type: 'radio', label_text: 'モジュラーケーブル', name: 'modular_cable', id: ['modular_cable_ok', 'modular_cable_ng'], value: ['改善', '改善なし'] };
const optical = [use, display, outside_call, modular_cable];

//下の項目その2
const reboot = { type: 'radio', label_text: 'リブート', name: 'reboot', id: ['reboot_ok', 'reboot_ng'], value: ['改善', '改善なし'] };
const visit = { type: 'radio', label_text: '訪問', name: 'visit', id: ['visit_ok', 'visit_ng'], value: ['OK', 'NG'] };
const contact = { type: 'radio', label_text: '事前連絡', name: 'contact', id: ['contact_ok', 'contact_ng'], value: ['OK', 'NG'] };
const price = { type: 'radio', label_text: '料金', name: 'price', id: ['price_ok', 'price_ng'], value: ['OK', 'NG'] };
const contact_address = { type: 'text', id: 'contact_address', value: '折り返し先' };
const fault = [reboot, visit, contact, price, contact_address];



const history_lib = [rooter_power, alarm, ppp, light_tel, act, register, initial, option, Authentication, uni, optical_line, power, movie, lan_setup, lan_setup_ararm, user_account, cfs, tell_no, west_east, wireless_lan, wireless_model, rooter_mode, use, display, outside_call, modular_cable, reboot, visit, contact, price, contact_address];
